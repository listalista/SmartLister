...
public class RefinedProdList extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.refined_list);  /*Retrieving the contents of the layout refined_list*/
        
        listView = (ListView) findViewById(R.id.refinedlist); /*Declaring the List View*/
    ...
    public void onItemClick(AdapterView<?> adapter, View view, int position, long id) {
    	     ...
    	     Intent intent = new Intent(RefinedProdList.this, SelectedProduct.class);
