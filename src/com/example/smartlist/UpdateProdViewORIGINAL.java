...
public class UpdateProdViewORIGINAL extends Activity implements OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> adapter, View view, int position, long id) {
    	     ...
    	     Intent intent = new Intent(UpdateProdViewORIGINAL.this, UpdateProdTitle.class);
